...
q_split <- function(task) {
  ...
  familiar_folder <- "/work/bachelor/preprocessing/preprocessed_Questions_fam"
  unfamiliar_folder <- "/work/bachelor/preprocessing/preprocessed_Questions_unfam"
  source_folder <- "/work/bachelor/preprocessing/preprocessed_Questions"
  ...
  # renaming old folder
  file.rename(source_folder, "/work/bachelor/preprocessing/Questions_transcripts")
  }
}
